...
internal const val PROVIDER = "$FACADE_PACKAGE$TEMPLATE_PACKAGE.IProvider"
internal const val PROVIDER_GROUP = "$FACADE_PACKAGE$TEMPLATE_PACKAGE.IProviderGroup"
internal const val INTERCEPTOR = "$FACADE_PACKAGE$TEMPLATE_PACKAGE.IInterceptor"
internal const val INTERCEPTOR_GROUP = "$FACADE_PACKAGE$TEMPLATE_PACKAGE.IInterceptorGroup"
internal const val ROUTE_ROOT = "$FACADE_PACKAGE$TEMPLATE_PACKAGE.IRouteRoot"
internal const val ROUTE_GROUP = "$FACADE_PACKAGE$TEMPLATE_PACKAGE.IRouteGroup"
internal const val SYRINGE = "$FACADE_PACKAGE$TEMPLATE_PACKAGE.ISyringe"
